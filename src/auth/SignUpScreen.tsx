    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {successMsg && (
            <div className="p-3.5 rounded-xl bg-green-50 border border-green-200 text-green-700 text-sm font-semibold flex items-center gap-2">
              ...
              <input
                ...
                className={`w-full pl-11 pr-4 py-3.5 bg-white/90 rounded-xl text-slate-900 placeholder-slate-400 font-medium focus:outline-none focus:ring-4 transition-all duration-200 shadow-sm ${
                  fieldErrors.username
                    ? "border-2 border-red-400 focus:ring-red-500/20"
                    : "border border-slate-200/90 focus:ring-orange-500/20 focus:border-orange-500 focus:bg-white"
                }`}
              />
            </div>
            {fieldErrors.username && (
