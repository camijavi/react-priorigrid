    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3.5 bg-white/90 border border-slate-200/90 rounded-xl text-slate-900 placeholder-slate-400 font-medium focus:outline-none focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 focus:bg-white transition-all duration-200 shadow-sm"
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-11 pr-12 py-3.5 bg-white/90 border border-slate-200/90 rounded-xl text-slate-900 placeholder-slate-400 font-medium focus:outline-none focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 focus:bg-white transition-all duration-200 shadow-sm"
              />
              <button
                type="button"
        ...
        <div className="pt-4 border-t border-slate-200/80 flex flex-col items-center gap-2.5">
          <p className="text-xs text-slate-500 font-semibold tracking-wide">Developed by Camila Javiera</p>
